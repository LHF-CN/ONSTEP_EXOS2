...
#define AXIS1_STEPS_PER_DEGREE    3840.0000000 //  12800, n. Number of steps per degree:                                          <-Req'd
...
#define AXIS2_STEPS_PER_DEGREE    3840.0000000 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define FEATURE1_NAME          "TIME" // "FE..", Name of feature being controlled.                                        Adjust
